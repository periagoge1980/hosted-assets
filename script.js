        ...
        fetch(apiUrl)
            ...
            .then(apiData => {
                ...
                if (yearsInSelectedCountry > 100) {
                    document.getElementById("result").innerHTML = `<b>Great choice! ${country} is a great retirement destination.</b> <br><br>You clearly would not have to worry in ${country} as your funds could last you more than a lifetime. Assuming you adjust your spending to match the middle-class lifestyle of that country, they would last you (approximately ${yearsInSelectedCountry} years and ${monthsInSelectedCountry} months). <br><br><br><br>Your retirement funds would also last you much longer there compared to in ${currentCountry}, where they would last approximately ${yearsInCurrentCountry} years and ${monthsInCurrentCountry} months.<b>Now, consider the price range for these common expenses in ${country}:</b>`;
                } else {
